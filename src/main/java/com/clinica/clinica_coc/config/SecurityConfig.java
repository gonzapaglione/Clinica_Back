    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(authRequest -> authRequest
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/pacientes/persona/**")
                        .hasAnyAuthority("Paciente", "Admin")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/odontologos/*/horarios-disponibles")
                        .hasAnyAuthority("Paciente", "Odontologo", "Admin")
                        .requestMatchers(HttpMethod.GET, "/api/odontologos/*/dias-disponibles")
                        .hasAnyAuthority("Paciente", "Odontologo", "Admin")
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/turnos/odontologo/**")
                        .hasAnyAuthority("Paciente", "Odontologo", "Admin")
